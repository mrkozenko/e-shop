        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('index_admin')}}">Товари</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('crud_categories')}}">Категорії</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('show_images')}}">Зображення</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('show_list_admin_orders')}}">Замовлення</a>
                    </li>
